function [img] = modeshapes_see_dataset_histogram(baseFolder, nModesSee, startWithMode, step, csvName, saveDir, saveName)
% 
if nargin<4, step = 1; end
if nargin<6, saveData = false; else, saveData = true; end

if nargin <5
    [Dataset_FA, csvPath, datasetType, datasetDistr] = fetchDataset_plate(saveData, baseFolder, true);
else
    [Dataset_FA, csvPath, datasetType, datasetDistr] = fetchDataset_plate(saveData, baseFolder, true, csvName);
end
