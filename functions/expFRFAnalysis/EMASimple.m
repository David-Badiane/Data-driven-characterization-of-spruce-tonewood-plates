function [Hv,f0, fLocs, bandsIdxs] = EMASimple(HvSVD, fAxis,minPeakVal, minPeakWidth, plotData)
...
%      end
    [bandsIdxs, coarseIndexes] = findSubBands(Hv, fAxis, fAmps, fLocs, deltafLocs, plotData); 
    bandsLength = bandsIdxs(:,2)-bandsIdxs(:,1);
%     
%     
